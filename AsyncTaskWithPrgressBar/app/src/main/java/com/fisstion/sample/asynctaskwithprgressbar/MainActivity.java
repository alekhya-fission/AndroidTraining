package com.fisstion.sample.asynctaskwithprgressbar;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnShowProgressDialog=(Button)findViewById(R.id.btnShowImage);
        mImageView=(ImageView)findViewById(R.id.imvPicture);
